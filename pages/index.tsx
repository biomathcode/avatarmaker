...
const Home: NextPage = () => {
  ...
  const increase = () => {
    state === Number(EmotionTypes.length -1) ? setState(0): 
  ...
  const decrease = () => {
    ...
    state <= 0 ? setState(Number(EmotionTypes.length -1)) : 
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>How to create Avatar Maker or Avatar Generator with React || Nextjs</title>
      ...
      <main className={styles.main}>
        ...
        target={'_blank'}
        rel="noreferrer"
        href={link} className="blue mt-30">
          Link Preview 
